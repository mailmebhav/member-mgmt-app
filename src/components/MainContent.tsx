...
import {  Container, Grid , Avatar, Card, CardContent, Typography, CardActionArea, } from '@mui/material';
...
const MainContent = () => {
  ...
  return (
    ...
    <Grid item xs={12} md={6}>
      <Card 
        sx={{ minWidth: 100, maxWidth: 350, boxShadow: 'rgba(0, 0, 0, 0.1) 0px 4px 100px' }}
      >
        <CardActionArea
          sx={{
            display: 'flex',
